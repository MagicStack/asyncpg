...
class PostgresConnectionError(PostgresConnectionError):
    sqlstate = '08006'
...
class ModifyingSQLDataNotPermittedError(ExternalRoutineError):
    sqlstate = '38002'


class ProhibitedSQLStatementAttemptedError(ExternalRoutineError):
    sqlstate = '38003'


class ReadingSQLDataNotPermittedError(ExternalRoutineError):
    sqlstate = '38004'
...
class NullValueNotAllowedError(ExternalRoutineInvocationError):
    sqlstate = '39004'
...
__all__ = _base.__all__ + (
    'PostgresWarning', 'DynamicResultSetsReturned',
    'ImplicitZeroBitPadding', 'NullValueEliminatedInSetFunction',
    'PrivilegeNotGranted', 'PrivilegeNotRevoked',
    'StringDataRightTruncation', 'DeprecatedFeature', 'NoData',
    'NoAdditionalDynamicResultSetsReturned',
    'SQLStatementNotYetCompleteError', 'PostgresConnectionError',
    'ConnectionDoesNotExistError', 'PostgresConnectionError',
    'ClientCannotConnectError', 'ConnectionRejectionError',
    'TransactionResolutionUnknownError', 'ProtocolViolationError',
    'TriggeredActionError', 'FeatureNotSupportedError',
    'InvalidTransactionInitiationError', 'LocatorError',
    'InvalidLocatorSpecificationError', 'InvalidGrantorError',
    'InvalidGrantOperationError', 'InvalidRoleSpecificationError',
    'DiagnosticsError',
    'StackedDiagnosticsAccessedWithoutActiveHandlerError',
    'CaseNotFoundError', 'CardinalityViolationError', 'DataError',
    'ArraySubscriptError', 'CharacterNotInRepertoireError',
    'DatetimeFieldOverflowError', 'DivisionByZeroError',
    'ErrorInAssignmentError', 'EscapeCharacterConflictError',
    'IndicatorOverflowError', 'IntervalFieldOverflowError',
    ...
    'InvalidCharacterValueForCastError', 'InvalidDatetimeFormatError',
    'InvalidEscapeCharacterError', 'InvalidEscapeOctetError',
    'InvalidEscapeSequenceError', 'NonstandardUseOfEscapeCharacterError',
    'InvalidIndicatorParameterValueError', 'InvalidParameterValueError',
    'InvalidRegularExpressionError', 'InvalidRowCountInLimitClauseError',
    ...
    'InvalidUseOfEscapeCharacterError', 'MostSpecificTypeMismatchError',
    'NullValueNotAllowedError', 'NullValueNoIndicatorParameterError',
    'NumericValueOutOfRangeError', 'StringDataLengthMismatchError',
    'StringDataRightTruncationError', 'SubstringError', 'TrimError',
    'UnterminatedCStringError', 'ZeroLengthCharacterStringError',
    'PostgresFloatingPointError', 'InvalidTextRepresentationError',
    'InvalidBinaryRepresentationError', 'BadCopyFileFormatError',
    'UntranslatableCharacterError', 'NotAnXmlDocumentError',
    'InvalidXmlDocumentError', 'InvalidXmlContentError',
    'InvalidXmlCommentError', 'InvalidXmlProcessingInstructionError',
    'IntegrityConstraintViolationError', 'RestrictViolationError',
    'NotNullViolationError', 'ForeignKeyViolationError',
    'UniqueViolationError', 'CheckViolationError',
    'ExclusionViolationError', 'InvalidCursorStateError',
    'InvalidTransactionStateError', 'ActiveSQLTransactionError',
    ...
    'NoActiveSQLTransactionError', 'InFailedSQLTransactionError',
    'IdleInTransactionSessionTimeoutError',
    'InvalidSQLStatementNameError', 'TriggeredDataChangeViolationError',
    'InvalidAuthorizationSpecificationError', 'InvalidPasswordError',
    'DependentPrivilegeDescriptorsStillExistError',
    'DependentObjectsStillExistError',
    'InvalidTransactionTerminationError', 'SQLRoutineError',
    'FunctionExecutedNoReturnStatementError',
    'ModifyingSQLDataNotPermittedError',
    'ProhibitedSQLStatementAttemptedError',
    'ReadingSQLDataNotPermittedError', 'InvalidCursorNameError',
    'ExternalRoutineError', 'ContainingSQLNotPermittedError',
    'ModifyingSQLDataNotPermittedError',
    'ProhibitedSQLStatementAttemptedError',
    'ReadingSQLDataNotPermittedError', 'ExternalRoutineInvocationError',
    'InvalidSqlstateReturnedError', 'NullValueNotAllowedError',
    'TriggerProtocolViolatedError', 'SrfProtocolViolatedError',
    'EventTriggerProtocolViolatedError', 'SavepointError',
    'InvalidSavepointSpecificationError', 'InvalidCatalogNameError',
    'InvalidSchemaNameError', 'TransactionRollbackError',
    'TransactionIntegrityConstraintViolationError', 'SerializationError',
    'StatementCompletionUnknownError', 'DeadlockDetectedError',
    'SyntaxOrAccessError', 'PostgresSyntaxError',
    'InsufficientPrivilegeError', 'CannotCoerceError', 'GroupingError',
    'WindowingError', 'InvalidRecursionError', 'InvalidForeignKeyError',
    'InvalidNameError', 'NameTooLongError', 'ReservedNameError',
    'DatatypeMismatchError', 'IndeterminateDatatypeError',
    'CollationMismatchError', 'IndeterminateCollationError',
    'WrongObjectTypeError', 'UndefinedColumnError',
    'UndefinedFunctionError', 'UndefinedTableError',
    'UndefinedParameterError', 'UndefinedObjectError',
    'DuplicateColumnError', 'DuplicateCursorError',
    'DuplicateDatabaseError', 'DuplicateFunctionError',
    'DuplicatePreparedStatementError', 'DuplicateSchemaError',
    'DuplicateTableError', 'DuplicateAliasError', 'DuplicateObjectError',
    'AmbiguousColumnError', 'AmbiguousFunctionError',
    'AmbiguousParameterError', 'AmbiguousAliasError',
    'InvalidColumnReferenceError', 'InvalidColumnDefinitionError',
    'InvalidCursorDefinitionError', 'InvalidDatabaseDefinitionError',
    'InvalidFunctionDefinitionError',
    'InvalidPreparedStatementDefinitionError',
    'InvalidSchemaDefinitionError', 'InvalidTableDefinitionError',
    'InvalidObjectDefinitionError', 'WithCheckOptionViolationError',
    'InsufficientResourcesError', 'DiskFullError', 'OutOfMemoryError',
    'TooManyConnectionsError', 'ConfigurationLimitExceededError',
    'ProgramLimitExceededError', 'StatementTooComplexError',
    'TooManyColumnsError', 'TooManyArgumentsError',
    'ObjectNotInPrerequisiteStateError', 'ObjectInUseError',
    'CantChangeRuntimeParamError', 'LockNotAvailableError',
    'OperatorInterventionError', 'QueryCanceledError',
    'AdminShutdownError', 'CrashShutdownError', 'CannotConnectNowError',
    'DatabaseDroppedError', 'PostgresSystemError', 'PostgresIOError',
    'UndefinedFileError', 'DuplicateFileError', 'SnapshotTooOldError',
    'ConfigFileError', 'LockFileExistsError', 'FDWError',
    ...
    'FDWInvalidColumnNumberError', 'FDWInvalidDataTypeError',
    'FDWInvalidDataTypeDescriptorsError',
    'FDWInvalidDescriptorFieldIdentifierError', 'FDWInvalidHandleError',
    'FDWInvalidOptionIndexError', 'FDWInvalidOptionNameError',
    'FDWInvalidStringLengthOrBufferLengthError',
    'FDWInvalidStringFormatError', 'FDWInvalidUseOfNullPointerError',
    'FDWTooManyHandlesError', 'FDWOutOfMemoryError', 'FDWNoSchemasError',
    'FDWOptionNameNotFoundError', 'FDWReplyHandleError',
    'FDWSchemaNotFoundError', 'FDWTableNotFoundError',
    'FDWUnableToCreateExecutionError', 'FDWUnableToCreateReplyError',
    'FDWUnableToEstablishConnectionError', 'PLPGSQLError', 'RaiseError',
    'NoDataFoundError', 'TooManyRowsError', 'AssertError',
    'InternalServerError', 'DataCorruptedError', 'IndexCorruptedError'
)
